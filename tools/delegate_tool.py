        ...
        "properties": {
            ...
            "provider": {
                ...
                "description": (
                    ...
                    "'custom:<name>' provider). Overrides delegation.provider config. "
                    "When set, the subagent resolves that provider's full credential "
                    "bundle. Leave unset to inherit from delegation.provider config "
                    "or parent."
                ),
            },
            "action": {
